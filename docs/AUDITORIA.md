...
| P-11 | Importante | La detección de secretos llegaba tarde (solo al exportar) y de pago; RGPD si el vault acaba en una carpeta sincronizada | **Aplicado en parte.** Aviso al copiar y gratis ✓; consentimiento explícito ✓; `PRIVACY.md` sin servidor ✓. **El cifrado del vault NO está implementado** — decisión pendiente para la 0.3.0 (o retirada explícita de la promesa). Corregido el 2026-08-17: esta fila lo daba por hecho |
